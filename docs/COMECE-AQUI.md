# 🏠 Comece aqui — Colaborador (Corretor ZX Control)

Você vai ajudar a construir um produto: um sistema de atendimento por WhatsApp pra corretores de
...
1. **Aceite o convite do repositório.** Chegou um convite no email da sua conta GitHub (`agalon-hash`).
   ...
   👉 https://github.com/zxmarketingdigital/corretor-zx-control/invitations
...
3. **Conecte o repositório** `zxmarketingdigital/corretor-zx-control` dentro do Claude Code.
